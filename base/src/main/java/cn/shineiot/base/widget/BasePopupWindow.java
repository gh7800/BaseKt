...
public class BasePopupWindow extends PopupWindow {
    ...
    public BasePopupWindow(Context context) {
        ...
        initBasePopupWindow(ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT);
    }

    public BasePopupWindow(Context context, Integer width, Integer height) {
        this.mContext = context;
        initBasePopupWindow(width, height);
    }
     ...
     * */
    private void initBasePopupWindow(Integer width,Integer height) {
