 ...
 */
abstract class BaseAdapterVD<T> : RecyclerView.Adapter<RecyclerView.ViewHolder>, CoroutineScope {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            is KtViewHolder -> {
                ...
                convert(holder.viewDataBinding, item, holder.bindingAdapterPosition)
    ...
    open class KtViewHolder(viewDataBinding: ViewDataBinding) : RecyclerView.ViewHolder(viewDataBinding.root) {
